...
var getAnimalInfo =
    ...
    app.post("/upload", upload.single('file'), (req, res) => {
        ...
        var image = fs.readFileSync(data).toString("base64");

        var tp = new Promise((resolve, reject) => {
            youtu.imagetag(data, (res) => {
                resolve(res);
            })
        })
        ...
        // youtu.imagetag(data, function (response) {
...
function resHandler(resList) {
    ...
    var tags = tRes.data.tags.sort(function (a, b) {
